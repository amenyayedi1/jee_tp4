package metier; import java.util.List;
...
//Retourner la liste de tous les objets "User" public List<User> listUsers();
//Retourner l'objet "User" ayant le login et le password passés en paramètres
public User getUserByLoginAndPassword(String l, String p); //Mettre à jour un objet "User" déjà existant
